...
const DUMMY_ITEMS_COUNT = 2;
console.log("gl", Glider);
document.addEventListener("DOMContentLoaded", function () {
	...
	// skip dummy items
	glider.scrollItem(DUMMY_ITEMS_COUNT);

	glider.scrollToCenter = function (slideNum) {
		console.log("🚀 ~ file: scripts.js ~ line 39 ~ document.addEventListener ~ slideNum", typeof slideNum);
		const { breakpoint, opt, slide } = this;
		console.log(this);
		...
		console.log("🚀 ~ file: scripts.js ~ line 47 ~ document.addEventListener ~ slideNum + offsetToCenter", slideNum, offsetToCenter);

		this.scrollItem(slideNum - offsetToCenter);
	};

	// glider.scrollToCenter();
	glider.ele.addEventListener("click", e => {
		let slideNum = parseInt(e.target.closest("figure").dataset.gslide);
