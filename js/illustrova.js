(function (Shuffle,perfectScrollbar) {
'use strict';
...
var PortfolioNav = function PortfolioNav(element) {
...
var MyModal = function MyModal(element) {
  console.log(element);
  this.element = $(element);
...
MyModal.prototype.setNextModals = function (currentItem) {
  ...
  this.prevItem = $(this.currItem).parent().prev(':visible').find('.portfolio-item-link');
  this.nextItem = $(this.currItem).parent().next(':visible').find('.portfolio-item-link');
...
MyModal.prototype.loadContent = function (relatedItem) {
  ...
  //Load data
  var url = 'projects/' + item.attr('href');
...
MyModal.prototype.setBtnState = function () {
  this.prevItem.length <= 0 ? this.disableBtn(this.btnPrev) : this.enableBtn(this.btnPrev);
  this.nextItem.length <= 0 ? this.disableBtn(this.btnNext) : this.enableBtn(this.btnNext);
};
...
document.addEventListener('DOMContentLoaded', function () {
  console.log('loaded');
  window.portfolioNav = new PortfolioNav(document.querySelector('.portfolio-shuffle'));
  ...
  $('.main-content').fullpage({ //options here
    ...
    normalScrollElements: '.shuffle', afterResponsive: function afterResponsive(isResponsive) {
