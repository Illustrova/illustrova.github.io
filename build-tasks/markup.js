...
const watchMarkup = () => gulp.watch(src.markup.all, gulp.series(compileMarkup))
watchMarkup.description = `watch for changes in markup source(${
  src.markup.all
}) compile on change`
...
compileAjaxSources.description = `compile markup sources for ajax (${
  src.markup.ajax
}) in loop for project data using pug`
...
watchAjaxSources.description = `watch for changes in markup source(${
  src.markup.all
}) compile on change`
